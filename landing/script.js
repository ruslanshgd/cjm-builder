var I18N = {
  ru: {
    ...
    'hero.title': 'Превращайте интервью<br>в <span class="highlight">Customer Journey Map</span><br>прямо в Figma',
    'hero.subtitle': 'Загрузите транскрипт или таблицу — AI проанализирует путь пользователя, извлечёт этапы, действия, мысли, эмоции и построит визуальную CJM с привязкой к вашим экранам.',
    'hero.cta.install': 'Установить из Figma Community',
  ...
  en: {
    ...
    'hero.title': 'Turn interviews into<br><span class="highlight">Customer Journey Map</span><br>right in Figma',
    'hero.subtitle': 'Upload a transcript or spreadsheet — AI will analyze the user journey, extract stages, actions, thoughts, emotions and build a visual CJM linked to your screens.',
    'hero.cta.install': 'Install from Figma Community',
